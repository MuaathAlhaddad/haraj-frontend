          ...
          <b-col sm="9">
            <b-row>
              ...
              <b-col class="col-4" sm="6">
                <small class="text-muted">
                  <i class="far fa-clock">{{ calDuration(adData.created_at) }} </i>
  ...
  methods: {
    calDuration: function (created_at) {
      ...
      setInterval(function () {
        ...
        self.duration.hours = Math.floor((duration % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
        self.duration.mins = Math.floor((duration % (1000 * 60 * 60)) / (1000 * 60));
